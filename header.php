...
<html lang="pt-br">
	<head>
		...
		<meta name="description" content="<?php bloginfo('name'); ?> <?php wp_title('-') ?> <?php the_field('title_description') ?> ">

		<meta property="og:type" content="website"/>
		<meta property="og:title" content="<?php bloginfo('name'); ?> <?php wp_title('-') ?> <?php the_field('title_seo') ?> "/>
		<meta property="og:description" content="<?php bloginfo('name'); ?> <?php wp_title('-') ?> <?php the_field('title_description') ?> "/>
